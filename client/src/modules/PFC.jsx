...
export default function PFC() {
  ...
  const totalExpenses = useMemo(
    ...
    [housing, food, transport, lifestyle, health, obligations, leisure]
  );

  const surplus = totalIncome - totalExpenses;
  const savingsRate =
    ((fmt(obligations.sip) + fmt(obligations.rd)) / totalIncome) * 100 || 0;
  ...
  const pieData = useMemo(() => {
    ...
    return [
      {
        name: "Housing",
        value: Object.values(housing).reduce((a, b) => a + b, 0),
      },
      { name: "Food", value: Object.values(food).reduce((a, b) => a + b, 0) },
      {
        name: "Transport",
        value: Object.values(transport).reduce((a, b) => a + b, 0),
      },
      {
        name: "Lifestyle",
        value: Object.values(lifestyle).reduce((a, b) => a + b, 0),
      },
      {
        name: "Health",
        value: Object.values(health).reduce((a, b) => a + b, 0),
      },
      {
        name: "Obligations",
        value: Object.values(obligations).reduce((a, b) => a + b, 0),
      },
      {
        name: "Leisure",
        value: Object.values(leisure).reduce((a, b) => a + b, 0),
      },
    ].filter((d) => d.value > 0);
  }, [
    housing,
